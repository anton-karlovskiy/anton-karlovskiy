...
In recent years, I’ve worked on the Google Chrome team and the Nuxt team on AI engineering, web front-end development, performance optimization, and best practices in modern web frameworks (React.js and Vue.js), with a strong focus on AI automation and user experience improvements.

These days, I’m passionate about advancing AI technologies, with a focus on machine learning, deep learning, generative AI, and agentic AI, while also applying my expertise in blockchain through smart contract, dApp, DeFi, NFT, and DAO development.
...
- Smart Insights Agent ([GitHub](https://github.com/anton-karlovskiy/smart-insights-agent) | [Docs](https://github.com/anton-karlovskiy/smart-insights-agent/tree/main/docs))
...
- Mantle Bridge at Windranger Labs ([GitHub](https://github.com/windranger-io/mantle-xyz) | [Web App](https://bridge.mantle.xyz))
- Mantle Public API at Windranger Labs ([GitHub](https://github.com/mantle-xyz/api) | [API](https://api.mantle.xyz))
- Mantle Website at Windranger Labs ([GitHub](https://github.com/windranger-io/mantle-xyz) | [Website](https://mantle.xyz))
- BitDAO Public API at BitDAO ([GitHub](https://github.com/bitdao-io/public-api) | [API](https://api-public.bitdao.io))
...
- Py2Cpp Accelerator ([GitHub](https://github.com/anton-karlovskiy/py2cpp-accelerator))
